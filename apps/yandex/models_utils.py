...
class CapabilityType(TextChoices):
...
class ModeInstance(TextChoices):
    """
...
class RangeInstance(TextChoices):
    """
...
class ToggleInstance(TextChoices):
    """
