# Generated by Django 4.0.4 on 2022-06-20 12:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('float', 'Float'), ('event', 'Event')], max_length=100, verbose_name='Тип устройства')),
        ...
        migrations.AddField(
            model_name='device',
            name='room',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='yandex.room', verbose_name='Комната'),
        ),
        migrations.AddField(
            model_name='device',
            name='yd',
