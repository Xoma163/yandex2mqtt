# Generated by Django 4.0.4 on 2022-06-20 06:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oauth_token', models.CharField(help_text='https://oauth.yandex.ru/authorize?response_type=token', max_length=40, verbose_name='OAuth токен')),
                ('skill_id', models.UUIDField(help_text='https://dialogs.yandex.ru/developer/skills/{skill_id}', verbose_name='Ид навыка в яндексе')),
            ],
            options={
